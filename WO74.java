...
public class WO74 extends Event {
    public WO74(Campaign camp) {
        super("/Users/saahilherrero/Downloads/Images/Winter Outpost Front/WO74.png", "/Users/saahilherrero/Downloads/Images/Winter Outpost Back/WO74.png", camp);
    }
    ...
    public ArrayList<JButton> getButtons(JLayeredPane layeredPane, JDialog dialog) {
        ...
        button1.addActionListener(_ ->
        {
            ...
            if (camp.ancestryInParty("Unfettered")) {
                ...
                buttonc.addActionListener(_ ->
                {
                    ...
                    dialog.dispose();
                    System.out.println(camp.selectCharacter("Unfettered") + " starts next scenario discarding a card (to be done)");
                    camp.inspiration++;
                });
            } else {
                buttonc.setBounds(101, 264, 55, 20);
                buttonc.addActionListener(_ ->
                {
        ...
        button2.addActionListener(_ ->
        {
            buttonClicked(dialog, layeredPane);
            JButton buttonc = new JButton("Continue");
            buttonc.setBounds(170, 468, 55, 20);
            buttonc.setFont(Methods.DEFAULTFONT);
            buttonc.addActionListener(_ ->
            {
                camp.inactiveWinterOutpost.add(camp.activeWinterOutpost.removeFirst());

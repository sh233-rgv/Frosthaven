...
public class Tile15 extends MapTile {
    //keyhex: Topmost row left
    public Tile15(char letter, int row, int col, Scenario scenario, int rotation) {
        super(row, col, letter, scenario, rotation, new Point(-150, -87), new Point[]{new Point(0, 0),
                new Point(-450, -87), new Point(-599, -347), new Point(-301, -520), new Point(-150, -607), new Point(0, -347)}, 25.80645161);
    }
    ...
    public void getHexes() {
        ...
        int[][] offsets = switch (rotation) {
            case 0 -> new int[][]{
                    ...
                    {5, even}, {5, even + 1}, {5, even + 2}, {5, even + 3}, {5, even + 4},
                    {6, 0}, {6, 1}, {6, 2}, {6, 3}
            };
            case 60 -> new int[][]{
                    {0, 0}, {0, -1}, {0, -2},
            ...
            case 240 -> new int[][]{
                    ...
                    {-1, even}, {-1, even + 1}, {-1, even + 2}, {-1, even + 3}, {-1, even + 4},
                    {-2, -1}, {-2, 0}, {-2, 1}, {-2, 2}, {-2, 3}, {-2, 4},
                    {-3, even - 1}, {-3, even}, {-3, even + 1}, {-3, even + 2}, {-3, even + 3}, {-3, even + 4}, {-3, even + 5},
                    {-4, -1}, {-4, 0}, {-4, 1}, {-4, 2}, {-4, 3}, {-4, 4},
                    {-5, even}, {-5, even + 1}, {-5, even + 2}, {-5, even + 3}, {-5, even + 4},
                    {-6, 1}, {-6, 2}, {-6, 3}
            };

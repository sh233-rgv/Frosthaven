...
public class LumberDepot extends Building {
    public LumberDepot(Campaign camp) {
        BuildingCost[] lvlCosts = new BuildingCost[2];
        lvlCosts[0] = new BuildingCost(6, 2, 2, 3);
        ...
        upEff[0] = new BuildingUpgradeEffect(1, 144.3, new int[]{}, 0, 0);
        ...
        frontImages = new String[]{"/Users/saahilherrero/Downloads/Images/Building Fronts/LumberDepot1.png",
                "/Users/saahilherrero/Downloads/Images/Building Fronts/LumberDepot2.png"};
        backImages = new String[]{"/Users/saahilherrero/Downloads/Images/Building Backs/LumberDepot1.png",
                "/Users/saahilherrero/Downloads/Images/Building Backs/LumberDepot2.png",};
    }
    ...
    public void buildingOperations(JLayeredPane layeredPane, JDialog dialog) {
        if (!wrecked) {
            ...
            JButton payLumber = new JButton("Pay Lumber");

...
public class Tile8 extends MapTile {
    //keyhex: top left
    public Tile8(char letter, int row, int col, Scenario scenario, int rotation) {
        super(row, col, letter, scenario, rotation, new Point(-200, -87), new Point[]{new Point(0, 0),
                new Point(-275, -130), new Point(-425, -304), new Point(-302, -348), new Point(-125, -565), new Point(25, -391)}, 25.75423105);
    }

...
public class Tile13 extends MapTile {
    //keyhex: Top left
    public Tile13(char letter, int row, int col, Scenario scenario, int rotation) {
        super(row, col, letter, scenario, rotation, new Point(-50, -87), new Point[]{new Point(0, 0),
                new Point(-501, 0), new Point(-701, -261), new Point(-400, -522), new Point(-250, -608), new Point(-50, -347)}, 25.72898799);
    }
    ...
    public void getHexes() {
        ...
        int[][] offsets = switch (rotation) {
            case 0 -> new int[][]{
                    ...
                    {2, 0}, {2, 1}, {2, 2}, {2, 3}, {2, 4},
                    {3, even + 1}, {3, even + 2}, {3, even + 3}, {3, even + 4},
                    {4, 0}, {4, 1}, {4, 2}, {4, 3}, {4, 4},
                    {5, even + 1}, {5, even + 2}, {5, even + 3}, {5, even + 4},
                    {6, 0}, {6, 1}, {6, 2}, {6, 3}, {6, 4}
            };
            case 60 -> new int[][]{
                    {0, 0},
                    ...
                    {2, -3}, {2, -2}, {2, -1}, {2, 0}, {2, 1},
                    {3, even - 4}, {3, even - 3}, {3, even - 2}, {3, even - 1}, {3, even}, {3, even + 1}, {3, even + 2},
            ...
            case 180 -> new int[][]{
                    ...
                    {-4, 0}, {-4, -1}, {-4, -2}, {-4, -3}, {-4, -4},
                    {-5, even}, {-5, even - 1}, {-5, even - 2}, {-5, even - 3},
                    {-6, 0}, {-6, -1}, {-6, -2}, {-6, -3}, {-6, -4}
            };
            case 240 -> new int[][]{
                    {0, 0},
                    ...
                    {-4, 4}, {-4, 3}, {-4, 2}, {-4, 1}, {-4, 0}, {-4, -1}, {-4, -2},
                    {-5, even + 4}, {-5, even + 3}, {-5, even + 2}, {-5, even + 1}, {-5, even},
                    {-6, 3}, {-6, 2}, {-6, 1},
                    {-7, even + 3}
            };
            case 300 -> new int[][]{
